...
def noveltyslice(
	...
	ret = subprocess.call([
		...
		"-filtersize", str(filtersize), str(filtersize),
...
def transients(
	...
	numframes:int = -1,
	startchan:int = 0,
	startframe:int = 0) -> TransientsOutput:
...
def hpss(
	...
	ret = subprocess.call([
		...
		"-residual", str(residual),
		"-fftsettings", str(fftsettings[0]), str(fftsettings[1]), str(fftsize), str(fftsize),
		"-harmfiltersize", str(harmfiltersize), str(harmfiltersize),
		"-percfiltersize", str(percfiltersize), str(percfiltersize),
