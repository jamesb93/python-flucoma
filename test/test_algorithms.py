...
def test_nmf():
    ...
    hopsize = fftsize / 2
    output = fluid.nmf(
        test_file, iterations=1, components=3, fftsettings=[fftsize, hopsize, fftsize]
    )
...
def test_spectralshape():
    fftsize = 256
    hopsize = fftsize / 2
    output = fluid.spectralshape(test_file, fftsettings=[fftsize, hopsize, fftsize])
...
def test_pitch():
    fftsize = 256
    hopsize = fftsize / 2
    output = fluid.pitch(test_file, fftsettings=[fftsize, hopsize, fftsize])
